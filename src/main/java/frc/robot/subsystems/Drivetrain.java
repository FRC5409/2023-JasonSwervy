...
public class Drivetrain extends SubsystemBase {
    ...
    public Drivetrain() {
        ...
        if (debugMode) {
            ...
            sb_drivetrainTab.addNumber("ABSANGLE Front left",  () -> mod_frontLeft.getAbsoluteTurnEncoderPositionDegrees())    .withPosition(0, 2);
            sb_drivetrainTab.addNumber("ABSANGLE Front right", () -> mod_frontRight.getAbsoluteTurnEncoderPositionDegrees())   .withPosition(1, 2);
            sb_drivetrainTab.addNumber("ABSANGLE Back left",   () -> mod_backLeft.getAbsoluteTurnEncoderPositionDegrees())     .withPosition(2, 2);
            sb_drivetrainTab.addNumber("ABSANGLE Back right",  () -> mod_backRight.getAbsoluteTurnEncoderPositionDegrees())    .withPosition(3, 2);
